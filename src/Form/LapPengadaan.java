 ...
 * @author User
 */
public class LapPengadaan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Form Laporan Pengadaan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
    ...
    private void cbNamaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbNamaItemStateChanged
        ...
        try {
            Statement st = conn.createStatement();
            ResultSet rs = st.executeQuery("select *from supplier where nama = '" + cbNama.getSelectedItem() + "'");
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LapPengadaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
