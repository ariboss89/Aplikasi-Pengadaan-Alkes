...
public class DataPelanggan extends javax.swing.JFrame {
    ...
    public void ViewData(){
        ...
        CustTable.addColumn("Id Pelanggan");
    ...
    public void Id(){
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select *from pelanggan ORDER BY idpelanggan DESC");
            if(rs.first() == false){
                lblId.setText("CST-0001");
            }
            else{
                rs.first();
                System.out.println("COT: "+ rs.getString("idpelanggan").substring(7, 8));
                int nokirim = Integer.valueOf(rs.getString("idpelanggan").substring(7 , 8))+1;
                System.out.println(nokirim);
                if(nokirim<10){
                    lblId.setText("CST-000"+nokirim);
                }else if(nokirim>=10 && nokirim<100){
                    lblId.setText("CST-00"+nokirim);
                }else if(nokirim>=100 && nokirim<1000){
                    lblId.setText("CST-0"+nokirim);
                }else if(nokirim>=1000 && nokirim<9999){
                    lblId.setText("CST-"+nokirim);
                }
            }
            rs.close();
        }catch(Exception ex){
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Form Pelanggan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if(txtNama.getText().isEmpty()){
            ...
            java.sql.Connection conn= new Database().connect();
            try{
                java.sql.PreparedStatement stmt=conn.prepareStatement("insert into pelanggan ( idpelanggan, nama, kontak, alamat) values (?,?,?,?)");
                try{
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try{
            ...
            java.sql.PreparedStatement stmt= conn.prepareStatement("update pelanggan set nama=?,kontak=?,alamat=? where idpelanggan =? ");
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
     ...
     try{
         java.sql.Statement stmt = conn.createStatement();
         SQL = " select *from pelanggan where idpelanggan like '%"+txtCari.getText()+"%' OR nama like '%"+txtCari.getText()+"%'";
         java.sql.ResultSet res=stmt.executeQuery(SQL);
         while(res.next()){
             CustTable.addRow(new Object[]{
                 res.getString("idpelanggan"),
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        ...
        if (evt.getKeyCode()== KeyEvent.VK_DELETE)
        {
            ...
            if(ok==0){
                try{
                    SQL="delete from pelanggan where idpelanggan ='"+lblId.getText()+"'";
    ...
    private void btnCancel1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancel1ActionPerformed
        ...
        java.sql.Connection conn= new Database().connect();
            try{
                File file = new File("src/Report/LapPelanggan.jrxml");
